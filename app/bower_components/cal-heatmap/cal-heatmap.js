...
Legend.prototype.buildColors = function() {
	...
	if(_legend[0] == 0){
		//remove the 0 entry, and add on a duplicate of the legend max to satisfy d3.scale.threshold requirement that threshold.range() must be one entry longer than threshold.domain()
		_legend.shift();
