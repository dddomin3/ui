...
.factory('ticketImpulseChartService', ['$http', function($http){
	...
	var _init = function (dataArray, userParameters) {
		var _ndx = crossfilter(dataArray);
		var _dimensions = {};
		...
		var _chartParameters = {
			"daysBetween": (userParameters.highDate - userParameters.lowDate)/(1000*60*60*24)
		};
...
.factory('ticketImpulseDataService', ['$http', 'ticketImpulseChartService', function($http, chartService) {
	...
	var _organizationQuery = {};
		...
		//TODO: remember it's a singleton! if another controller forces a repopulate, this
		//will probably break stuff. fix it so it doesn't do that.
	...
	var _successData = function (data, activeOrganizations) {
		...
		var poo = chartService.init(dataArray);
		console.log(poo);
		
		//TODO: maybe make the controller run these...
		//_createDimensions();
		//_createDomain();
        //_createGroups();
	};
...
.controller('ticketImpulseCtrl', ['$scope', '$location', '$route', 'ticketImpulseDataService', 
